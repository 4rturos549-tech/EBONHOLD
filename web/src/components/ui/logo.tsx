...
/**
 * Logo de Ebonhold. Diamante de Acherus con cristal de Frostmourne en el centro.
 * Acepta tamano en pixeles via prop `size`.
 */
export function Logo({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={cn(withGlow && "drop-shadow-[0_0_8px_rgba(110,200,240,0.4)]", className)}
      aria-hidden="true"
    >
      <defs>
      ...
      />
      <path
        d="M32 17 L36 32 L32 47 L28 32 Z"
        fill="url(#logo-shard)"
        stroke="#a8ddf5"
        strokeWidth="0.5"
      />
